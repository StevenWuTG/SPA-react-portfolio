    ...
    return (
        <div className="intro" id="intro">
            <wrapper>
                ...
                <p>As a avid gamer, it has always been one of my dreams to learn how to program and I fell in love after writing my first few lines of code. A day later, I've decided to turn my dreams into reality by enrolling in The Flatiron School's Immersive Software Engineering bootcamp.</p>
                <br />
